...
export function FreelancerEmptyIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      aria-label="No invoices illustration"
      {...props}
    >
      ...
      <rect
        ...
        height="80"
        rx="8"
        className="fill-primary opacity-10 stroke-primary"
        strokeWidth="4"
      />
...
export function LPDiscoveryEmptyIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className="w-full h-full"
      aria-label="Empty marketplace illustration"
      {...props}
    >
...
export function LPPortfolioEmptyIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className="w-full h-full"
      aria-label="No funded positions illustration"
      {...props}
    >
      ...
      <path
        d="M60 140h80"
        className="stroke-on-surface-variant opacity-30"
        strokeWidth="4"
        strokeLinecap="round"
      />
...
export function PayerEmptyIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className="w-full h-full"
      aria-label="No payments illustration"
      {...props}
    >
...
export function NotificationsEmptyIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className="w-full h-full"
      aria-label="No governance proposals illustration"
      {...props}
    >
      {/* Abstract bell / alerts */}
      <circle cx="100" cy="100" r="90" className="fill-surface-variant opacity-20" />
      <path
        d="M100 60c-15 0 -25 10 -25 25v20l-10 15v5h70v-5l-10 -15v-20c0 -15 -10 -25 -25 -25z"
        className="fill-primary opacity-10 stroke-primary"
        strokeWidth="4"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M90 135c0 5 4 10 10 10s10 -5 10 -10"
        className="stroke-primary"
        strokeWidth="4"
        strokeLinecap="round"
      />
