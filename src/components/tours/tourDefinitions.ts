...
export const freelancerDashboardTour: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Notifications',
    content: 'The bell icon shows recent activity. Configure alerts in Settings → Notifications.',
  },
  {
...
export type TourId = 'freelancer-dashboard' | 'lp-discovery' | 'analytics' | 'governance';
