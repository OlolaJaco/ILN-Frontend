  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          This is a reminder that your payment for invoice <strong>#{invoiceId}</strong> is due on{' '}
        ...
        <Text style={text}>
          You can also view the invoice details on your{' '}
          <Link href={payerLink} style={link}>
            Payer Dashboard
          </Link>
          .
        </Text>
